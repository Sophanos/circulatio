...
- Browser/UI verification may use `agent-browser` (https://github.com/vercel-labs/agent-browser) or OpenAI Browser Use through the Codex in-app browser. Do not add Playwright browser tests, Playwright config, or Playwright package dependencies to this repo.
